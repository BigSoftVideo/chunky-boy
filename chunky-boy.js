...
var chunky_boy = (function() {
  var _scriptDir = typeof document !== 'undefined' && document.currentScript ? document.currentScript.src : undefined;
  if (typeof __filename !== 'undefined') _scriptDir = _scriptDir || __filename;
  return (
function(chunky_boy) {
  chunky_boy = chunky_boy || {};
...
var Module = typeof chunky_boy !== 'undefined' ? chunky_boy : {};
...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_just_return_test')) {
        Object.defineProperty(Module['ready'], '_just_return_test', { configurable: true, get: function() { abort('You are getting _just_return_test on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_just_return_test', { configurable: true, set: function() { abort('You are setting _just_return_test on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_heap_test')) {
        Object.defineProperty(Module['ready'], '_heap_test', { configurable: true, get: function() { abort('You are getting _heap_test on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_heap_test', { configurable: true, set: function() { abort('You are setting _heap_test on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_decode_from_callback')) {
        Object.defineProperty(Module['ready'], '_decode_from_callback', { configurable: true, get: function() { abort('You are getting _decode_from_callback on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_decode_from_callback', { configurable: true, set: function() { abort('You are setting _decode_from_callback on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_stop_decoding')) {
        Object.defineProperty(Module['ready'], '_stop_decoding', { configurable: true, get: function() { abort('You are getting _stop_decoding on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_stop_decoding', { configurable: true, set: function() { abort('You are setting _stop_decoding on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_start_event_loop')) {
        Object.defineProperty(Module['ready'], '_start_event_loop', { configurable: true, get: function() { abort('You are getting _start_event_loop on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_start_event_loop', { configurable: true, set: function() { abort('You are setting _start_event_loop on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 8544128,
    DYNAMIC_BASE = 13787008,
    DYNAMICTOP_PTR = 8543200;
...
var INITIAL_INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 209715200;if (!Object.getOwnPropertyDescriptor(Module, 'INITIAL_MEMORY')) Object.defineProperty(Module, 'INITIAL_MEMORY', { configurable: true, get: function() { abort('Module.INITIAL_MEMORY has been replaced with plain INITIAL_INITIAL_MEMORY (the initial value can be provided on Module, but after startup the value is only looked for on a local variable of that name)') } });
...
var wasmBinaryFile = 'chunky-boy.wasm';
...
var ASM_CONSTS = {
 ...
 2301176: function() {throw 'Canceled!'},  
 2301396: function($0, $1) {setTimeout(function() { _do_emscripten_dispatch_to_thread($0, $1); }, 0);}
};
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=8544112;function _emscripten_futex_wake(addr, count) {
  ...
  function cleanupThread(pthread_ptr) {
      ...
      if (pthread) {
        ...
        PThread.mainThreadBlock = 8543360;
        ...
        var pthreadMainJs = locateFile('chunky-boy.worker.js');
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(2, 1, fd, buf);
  try {
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(5, 1, fds, nfds, timeout);
  try {
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(7, 1, old_path, new_path);
  try {
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(9, 1, call, socketvararg);
  try {
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(14, 1, fd, pbuf);
  try {
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(17, 1, node, service, hint, out);
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 8543264, 4), 8543264);function _gmtime_r(time, tmPtr) {
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(19, 1, name);
  ...
  function runAndAbortIfError(func) {
      try {
        ...
        var ASYNCIFY_IMPORTS = ["env.call_js_reader","env.emscripten_sleep","env.emscripten_yield","env.invoke_*","env.__call_main","env.emscripten_sleep","env.emscripten_wget","env.emscripten_wget_data","env.emscripten_idb_load","env.emscripten_idb_store","env.emscripten_idb_delete","env.emscripten_idb_exists","env.emscripten_idb_load_blob","env.emscripten_idb_store_blob","env.SDL_Delay","env.emscripten_scan_registers","env.emscripten_lazy_load_code","env.emscripten_fiber_swap","wasi_snapshot_preview1.fd_sync","env.__wasi_fd_sync","env._emval_await"].map(function(x) {
          return x.split('.')[1];
        });
...
var proxiedFunctionTable = [null,___sys_fcntl64,___sys_fstat64,___sys_mkdir,___sys_open,___sys_poll,___sys_read,___sys_rename,___sys_rmdir,___sys_socketcall,___sys_stat64,___sys_unlink,_emscripten_set_canvas_element_size_main_thread,_fd_close,_fd_fdstat_get,_fd_seek,_fd_write,_getaddrinfo,_tzset,_sysconf];
...
var asmGlobalArg = {};
var asmLibraryArg = { "__assert_fail": ___assert_fail, "__clock_gettime": ___clock_gettime, "__handle_stack_overflow": ___handle_stack_overflow, "__sys_fcntl64": ___sys_fcntl64, "__sys_fstat64": ___sys_fstat64, "__sys_mkdir": ___sys_mkdir, "__sys_open": ___sys_open, "__sys_poll": ___sys_poll, "__sys_read": ___sys_read, "__sys_rename": ___sys_rename, "__sys_rmdir": ___sys_rmdir, "__sys_socketcall": ___sys_socketcall, "__sys_stat64": ___sys_stat64, "__sys_uname": ___sys_uname, "__sys_unlink": ___sys_unlink, "_emscripten_notify_thread_queue": __emscripten_notify_thread_queue, "abort": _abort, "call_js_decoded_audio_handler": call_js_decoded_audio_handler, "call_js_finished_handler": call_js_finished_handler, "call_js_metadata_handler": call_js_metadata_handler, "call_js_reader": call_js_reader, "clock": _clock, "clock_gettime": _clock_gettime, "emscripten_asm_const_iii": _emscripten_asm_const_iii, "emscripten_check_blocking_allowed": _emscripten_check_blocking_allowed, "emscripten_conditional_set_current_thread_status": _emscripten_conditional_set_current_thread_status, "emscripten_futex_wait": _emscripten_futex_wait, "emscripten_futex_wake": _emscripten_futex_wake, "emscripten_get_now": _emscripten_get_now, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_is_main_browser_thread": _emscripten_is_main_browser_thread, "emscripten_is_main_runtime_thread": _emscripten_is_main_runtime_thread, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_receive_on_main_thread_js": _emscripten_receive_on_main_thread_js, "emscripten_resize_heap": _emscripten_resize_heap, "emscripten_set_canvas_element_size": _emscripten_set_canvas_element_size, "emscripten_set_current_thread_status": _emscripten_set_current_thread_status, "emscripten_sleep": _emscripten_sleep, "emscripten_webgl_create_context": _emscripten_webgl_create_context, "environ_get": _environ_get, "environ_sizes_get": _environ_sizes_get, "exit": _exit, "fd_close": _fd_close, "fd_fdstat_get": _fd_fdstat_get, "fd_seek": _fd_seek, "fd_write": _fd_write, "gai_strerror": _gai_strerror, "getaddrinfo": _getaddrinfo, "getnameinfo": _getnameinfo, "gettimeofday": _gettimeofday, "gmtime_r": _gmtime_r, "initPthreadsJS": initPthreadsJS, "localtime_r": _localtime_r, "memory": wasmMemory || Module['wasmMemory'], "mktime": _mktime, "pthread_cleanup_pop": _pthread_cleanup_pop, "pthread_cleanup_push": _pthread_cleanup_push, "pthread_create": _pthread_create, "pthread_join": _pthread_join, "pthread_self": _pthread_self, "round": _round, "setTempRet0": _setTempRet0, "strftime": _strftime, "sysconf": _sysconf, "table": wasmTable, "time": _time };
...
/** @type {function(...*):?} */
var _just_return_test = Module["_just_return_test"] = createExportWrapper("just_return_test");

/** @type {function(...*):?} */
var _heap_test = Module["_heap_test"] = createExportWrapper("heap_test");
...
/** @type {function(...*):?} */
var _decode_from_callback = Module["_decode_from_callback"] = createExportWrapper("decode_from_callback");

/** @type {function(...*):?} */
var _stop_decoding = Module["_stop_decoding"] = createExportWrapper("stop_decoding");
...
// {{MODULE_ADDITIONS}}
  ...
  return chunky_boy.ready
}
);
})();
if (typeof exports === 'object' && typeof module === 'object')
      module.exports = chunky_boy;
    else if (typeof define === 'function' && define['amd'])
      define([], function() { return chunky_boy; });
    else if (typeof exports === 'object')
      exports["chunky_boy"] = chunky_boy;
