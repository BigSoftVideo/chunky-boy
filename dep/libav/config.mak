...
LIBAV_CONFIGURATION=--arch=x86_32 --cpu=generic --cc=emcc --extra-cflags=-m32 --extra-ldflags=-m32 --disable-shared --disable-doc --disable-inline-asm --disable-asm --prefix=/home/artur/software/chunky-boy/dep/libav/build/js/root
prefix=/home/artur/software/chunky-boy/dep/libav/build/js/root
...
SRC_PATH=.
CC_IDENT=emcc (Emscripten gcc/clang-like replacement) 1.39.20 (45d43807ec2b74673acc703dd1145ac0d2d1040a)
ARCH=c
INTRINSICS=none
CC=emcc
OBJCC=emcc
...
STRIP=true
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_DEFAULT_SOURCE
CFLAGS=  -m32 -std=c99 -fomit-frame-pointer -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -mllvm -stack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
OBJCFLAGS=  
ASFLAGS=  -m32 -g -Qunused-arguments
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
LDFLAGS= -m32  -Wl,-rpath-link=libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
...
CFLAGS-avplay=-D_GNU_SOURCE=1 -D_REENTRANT
ZLIB=-lz
LIB_INSTALL_EXTRA_CMD=$$(RANLIB) "$(LIBDIR)/$(LIBNAME)"
EXTRALIBS=-lX11 -lm -pthread 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
